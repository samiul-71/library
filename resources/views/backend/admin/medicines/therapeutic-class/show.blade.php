        ...
        <div class="box-body">
            ...
            <div class="row text-center">
                <div class="col-sm-12 text-center">
                    <a href="{!! route("admin.$module_path.edit", $therapeutic_class->id) !!}" class="btn btn-xs btn-primary">
                        <i class="fa fa-pencil"></i> {!! 'Edit/Update' !!}
                    </a>
                    <a href="{!! route("admin.$module_path.destroy", $therapeutic_class->id) !!}" class="btn btn-xs btn-danger record-destroy" id="record-destroy" title="Move to Trash" data-toggle="tooltip" data-placement="top">
