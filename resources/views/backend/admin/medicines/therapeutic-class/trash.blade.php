                ...
                <div class="box-body">
                                ...
                                @foreach( $therapeutic_classes as $key => $therapeutic_class)
                                    <tr>
                                        ...
                                        <td style="width: 140px;">
                                            <a class="btn btn-info btn-xs  record-restore" data-toggle="tooltip" data-placement="top" title="Restore" href="{{ route("admin.$module_path.restore", $therapeutic_class->id) }}">
                                                <i class="fa fa-refresh"></i> Restore
                                            </a>
                                            <a class="btn btn-danger btn-xs record-delete" data-toggle="tooltip" data-placement="top" title="Delete" href="{{ route("admin.$module_path.permanently-delete", $therapeutic_class->id) }}">
                    ...
                    @else
                        <div class="col-sm-12 text-center" style="padding: 150px 0;">
                            <h1 style="opacity: 0.3">You don't have any Deleted Therapeutic Class.</h1>
                        </div>
                    @endif
                </div>
            </div>
