...
@section('content')
    <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            {!! Form::model($pharmaceutical_companies, ['method' => 'PUT', 'route' => ["admin.pharmaceutical-companies.update", $pharmaceutical_companies->id], 'class' => 'form', 'role' => 'form']) !!}

            @include("backend.admin.medicines.pharmaceutical-companies.form")
