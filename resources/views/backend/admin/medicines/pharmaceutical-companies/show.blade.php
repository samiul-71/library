        ...
        <div class="box-body">
                    ...
                    <div class="table-responsive">
                        <table class="table ">
                            ...
                            <tr>
                                ...
                                <td> : </td>
                                <td>
                                    {{ $pharmaceutical_companies->registration_number }}
                                </td>
                            </tr>
                            <tr>
                                <td class="pull-right">
                                ...
                                <td> : </td>
                                <td>
                                    {{ $pharmaceutical_companies->phone }}
                                </td>
                            </tr>
                            <tr>
                                <td class="pull-right">
                                ...
                                <td> : </td>
                                <td>
                                    {{ $pharmaceutical_companies->company_type }}
                                </td>
                            </tr>
                            <tr>
                                <td class="pull-right">
                                ...
                                <td> : </td>
                                <td>
                                    @if($pharmaceutical_companies->registration_status && $pharmaceutical_companies->registration_status == 'applied')
                                        <span class="label label-primary">{!! 'Applied' !!}</span>
                                    @elseif($pharmaceutical_companies->registration_status && $pharmaceutical_companies->registration_status == 'pending')
                            ...
                            <tr>
                                ...
                                <td> : </td>
                                <td>
                                    @if($pharmaceutical_companies->status && $pharmaceutical_companies->status == 1)
            ...
            <div class="row text-center">
                <div class="col-sm-12 text-center">
                    <a href="{!! route('admin.pharmaceutical-companies.edit', $pharmaceutical_companies->id) !!}" class="btn btn-xs btn-primary">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.record-destroy').on("click", function(ev){
                ...
                var redirectURL = "{{ route('admin.pharmaceutical-companies.index') }}";
