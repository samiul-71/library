...
<div class="form-row mashb">
    @if(isset($therapeutic_class_groups))
        <div class="form-group col-md-4 previous_parent_id">
            {!! Form::label('previous_parent_id', 'Select Parent Therapeutic Class Group (If Any)') !!}
            {!! Form::text('previous_parent_id', old('previous_parent_id'), ['id'=>'previous_parent_id', 'class' => 'form-control previous_parent_id', 'placeholder' => $therapeutic_class_group_parent, 'disabled' => 'true']) !!}
        </div>
