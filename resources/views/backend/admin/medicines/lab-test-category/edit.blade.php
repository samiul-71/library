...
@section('content')
    <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            {!! Form::model($lab_tests_category, ['method' => 'PUT', 'route' => ["admin.lab-test-category.update", $lab_tests_category->id], 'class' => 'form', 'role' => 'form']) !!}

            @include("backend.admin.medicines.lab-test-category.form")
