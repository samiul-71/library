    ...
    */
    ...
    'backend' => [
        ...
        'general' => [
            ...
            'alert_sms' => [
                'delete_record_confirm'     => 'Are you sure you want to delete this record permanently? Proceed at your own risk. This can not be un-done.',
                'restore_record_confirm'    => 'Restore this record to its original state?',
            ],
        ],
